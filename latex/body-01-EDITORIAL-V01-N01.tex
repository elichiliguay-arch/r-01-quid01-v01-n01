...
\textcopyright\ 2026 Petruza, J. Publicado por Revista Latinoamericana de nuevas ideas. \par\vspace{6pt}
...
\par\smallskip\noindent\textbf{Keywords:} igital divide, digitalization, public policy
\end{otherlanguage}
\end{tcolorbox}
